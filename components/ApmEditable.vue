    ...
    <div class="apm-editable"
        ...
        <div class="front" v-if="!editMode"
            ...
            <span v-if="type === 'checkbox'">
                ...
                <b-form-checkbox
                    :switch="checkboxSwitch" v-model="value" v-else @click.native.prevent="onCheckboxClick">
                    {{ checkboxLabel }}
                </b-form-checkbox>
            </span>
            ...
            <span v-else>
                <span :class="{'text-muted': !valueToShow}">
                    {{ ((valueToShow || valueToShow === 0) ? valueToShow : 'not set') | truncate(charLimit) }}
                </span>
...
export default {
    ...
    props: {
        ...
        checkboxSwitch: {type: Boolean, default: false}, // for checkbox only
